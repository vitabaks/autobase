...
|---|---|---|
| `postgresql_index_maintenance.enabled` | `true` | Enables the role in playbooks that use this flag. |
| `postgresql_index_maintenance.start` | `0000` | Maintenance window start time in `HHMM`. |
| `postgresql_index_maintenance.stop` | `0600` | Maintenance window stop time in `HHMM`. |
